          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:block relative">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md transition"
              >
                Categories
                <svg
          ...
          <form onSubmit={handleSearch} className="hidden lg:block flex-1 max-w-md mx-4">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pl-10 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
              <svg
